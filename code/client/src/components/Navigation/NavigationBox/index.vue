            ...
            <div class="box">
                <ul class="df-sb">
                    <Btn
                        ...
                        :key="index"
                        :item="item"
                        :style="[show ? getDefaultStyle(index) : getTransformStyle(index)]"
                        @lookMore="lookMore"
                    >
                        <!-- <img :src="item.bg"> -->
                    </Btn>
        ...
        return {
            defaultList: [
                ...
                { icon: 'example', name: 'Example', path: '/example' },
                {
                    icon: 'icongithub',
                    name: 'Github',
                    link: 'https://github.com/beijidehuo'
                },
                {
                    icon: 'email',
                    name: 'Email',
                    link: 'mailto:1175807146@qq.com'
                }
            ...
            //     { icon: 'icongithub', name: 'Github', link: 'https://github.com/beijidehuo', bg: require(`assets/images/navigation/blog.jpg`) }
            // ],
...
.navigation-animate-leave-active {
    opacity: 0;
    transform: scale(1.35);
}
.navigation-animate-enter-active,
.navigation-animate-leave-active {
